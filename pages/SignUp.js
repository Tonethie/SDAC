        ...
        return (
            <View style={styles.container}>
                <View style={styles.campos}>
                    ...
                    <TextInput style={styles.input} placeholder="Seu nome" underlineColorAndroid='gray'></TextInput>
                    ...
                    <ListItem style={{width:250, marginBottom: 10}}>
                        <CheckBox style={{marginRight: 20 }} color='#f8606b' checked={false} />
                        <Text style={{color: '#334048', fontWeight: "bold", fontSize: 12}}>Eu concordo com os<Text style={styles.corTermos}> Termos de Serviços e Política de Privacidade.</Text></Text>
                    </ListItem>
                ...
                <View style={styles.temContaContainer}>
                    <Text style={{color: '#b3bdc4', fontWeight: "bold", fontSize: 12}}>Tem uma conta? <Text style={styles.corTermos}> Logar</Text></Text>
                </View>
            </View>
        );
